var parallax = (function() {
    var mountains = document.querySelector('.parallax-promo__layer--mountains');
    var train = document.querySelector('.parallax-promo__layer--train');
    var grass = document.querySelector('.parallax-promo__layer--grass');
